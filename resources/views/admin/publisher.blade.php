        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <a href="#" @click="addData()" class="btn btn-primary btn-sm">Add New Publisher</a>
                </div>
            ...
            <div class="modal-content">
                <form :action="actionUrl" method="POST" enctype="multipart/form-data" @submit="submitForm($event, data.id)">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel" v-if="!editStatus">Add New Publisher</h5>
                        <h5 class="modal-title" id="exampleModalLabel" v-if="editStatus">Edit Publisher</h5>
