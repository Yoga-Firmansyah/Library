    ...
    <div class="col">
        <div class="card border-0 shadow">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold"><i class="fas pencil-alt mr-2"></i>Update Publisher</h6>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('publishers.update', $publisher->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone_number" value="{{ old('phone_number', $publisher->phone_number) }}"
